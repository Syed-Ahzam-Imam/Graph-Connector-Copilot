...
public static class GraphHelper
{
    ...
    public static async Task RegisterSchemaAsync(string? connectionId, Schema schema)
    {
        ...
        var requestInfo = graphClient
            ...
            .Schema.ToGetRequestInformation();
        ...
        var requestMessage =
            await graphClient.RequestAdapter.ConvertToNativeRequestAsync<HttpRequestMessage>(
                requestInfo
            );
        ...
        if (responseMessage.IsSuccessStatusCode)
        {
            ...
            // in the response
            var operationId =
                responseMessage.Headers.Location?.Segments.Last()
    ...
    )
    {
        ...
        do
        {
            var operation = await graphClient
                .External.Connections[connectionId]
    ...
    public static async Task<Schema?> GetSchemaAsync(string? connectionId)
    {
        ...
        return await graphClient.External.Connections[connectionId].Schema.GetAsync();
    }
    ...
    public static async Task AddOrUpdateItemAsync(string? connectionId, ExternalItem item)
    {
        ...
        await graphClient.External.Connections[connectionId].Items[item.Id].PutAsync(item);
    }
    ...
    public static async Task DeleteItemAsync(string? connectionId, string? itemId)
    {
        ...
        await graphClient.External.Connections[connectionId].Items[itemId].DeleteAsync();
    }
}
